...
public class ObjElement extends Element implements Iterable<String> {
    ...
    ObjElement(HashMap<String, Element> elements) {
    ...
    public ObjElementBuilder toBuilder(){
        return new ObjElementBuilder(elements, true);
    }
    ...
    public ObjElement merge(Element updates) {
        if (updates instanceof ObjElement) {
            HashMap<String, Element> newElements = new HashMap<>(elements);
