 ...
 * @author tofar
 */
public class LessEqual<C extends Comparable> implements Criteria {

    final ValElement<C> element;

    @ConstructorProperties({"value"})
    public LessEqual(ValElement<C> element) {
    ...
    public String getDescription(ResourceBundle resources) {
        String value = resources.getString("CRITERIA_DESC_LESS_EQUAL");
        String param;
        if(element instanceof ValElement){
